...
ORIGINS = {
    ...
    "aviation": ("1910 年代", "飞行通常归功于纽约调酒师雨果·恩斯林，早期记录见于 1916 年酒谱。", "紫罗兰利口酒带来的淡色调让它与飞行时代的浪漫想象联系在一起。"),
    "bees-knees": ("禁酒令时期", "蜂之膝流行于美国禁酒令时期，蜂蜜与柑橘常被用来修饰当时烈酒的粗粝感。", "名字来自当时表示“极好”的俚语，因此带有轻快的年代气息。"),
    ...
    "boulevardier": ("1920 年代", "花花公子与 1920 年代巴黎的美国侨民圈有关，常和作家厄斯金·格温联系在一起。", "它像是把尼格罗尼的金酒换成威士忌，因此更温暖厚实。"),
    ...
    "brandy-crusta": ("19 世纪中叶", "白兰地库斯塔诞生于新奥尔良，常与调酒师约瑟夫·桑蒂尼联系在一起。", "杯口糖边和长柠檬皮让它成为许多酸酒与边车系作品的先声。"),
    "caipirinha": ("19-20 世纪", "凯匹林纳来自巴西民间饮酒传统，卡莎萨、青柠和糖构成最朴素的地方表达。", "它从乡土饮法逐渐进入国际酒吧，成为巴西最具代表性的鸡尾酒。"),
    "canchanchara": ("19 世纪", "坎查查拉与古巴东部独立战争时期的民间饮法有关。", "甘蔗烈酒、蜂蜜和青柠呈现出非常直接的加勒比性格。"),
    ...
    "chartreuse-swizzle": ("21 世纪初", "查特斯威泽是新世纪热带风格复兴中的代表作品。", "绿查特酒的草本力度与菠萝、青柠和法勒南姆形成明亮对比。"),
    "clover-club": ("19 世纪末", "三叶草俱乐部源自费城同名绅士俱乐部，19 世纪末到 20 世纪初已很流行。", "蛋白泡沫与覆盆子色泽让它在经典复兴中重新受到欢迎。"),
    "corpse-reviver-2": ("1930 年代", "死而复生2号因 1930 年代萨伏伊酒谱而广为人知。", "它属于“提神酒”家族，名字带有早餐后或宿醉后的俏皮意味。"),
    "cosmopolitan": ("1980-1990 年代", "大都会的现代版本在 1980 年代末到 1990 年代的美国酒吧走红。", "蔓越莓与柑橘让它成为城市夜生活中辨识度极高的粉红短饮。"),
    "daiquiri": ("19 世纪末", "得其利起源于古巴得其利矿区附近，常与美国工程师詹宁斯·考克斯的故事相连。", "朗姆、青柠和糖的骨架后来成为无数酸酒变化的基础。"),
    ...
    "hemingway-special": ("1930 年代", "海明威特调来自哈瓦那的佛罗里迪塔酒吧，与作家海明威的饮酒偏好相关。", "它在得其利的基础上加入葡萄柚与黑樱桃风味，并减少甜度。"),
    ...
    "pisco-punch": ("19 世纪末", "皮斯科宾治与旧金山的银行交易所酒吧密切相关。", "皮斯科与菠萝的组合让它在淘金时代后的西海岸酒吧中声名大噪。"),
    ...
    "vesper": ("1953 年", "维斯帕出自伊恩·弗莱明小说《皇家赌场》。", "它因邦德点单而成名，金酒、伏特加和利莱白构成冷冽而戏剧化的形象。"),
    ...
    "dons-special-daiquiri": ("1930 年代", "唐的特调得其利属于唐海滩客早期提基酒吧体系，把得其利的酸甜骨架拓展为多朗姆与热带糖浆的组合。", "它展现了提基文化喜欢复杂香料、分层朗姆和丰富装饰的特点。"),
    "fernandito": ("20 世纪后期", "菲奈特可乐源自阿根廷日常饮酒文化，菲奈布兰卡与可乐的搭配在当地极为流行。", "它从简单混饮进入国际酒单，保留了浓烈草本苦味和可乐甜感的反差。"),
    "french-connection": ("20 世纪后期", "法国贩毒网因 1970 年代同名电影而被广泛记住，干邑与杏仁利口酒的组合强调餐后酒气质。", "它的流行来自简洁配方和电影时代的酷感命名。"),
    ...
    "grand-margarita": ("现代变体", "至尊玛格利塔是玛格丽塔的现代升级版本，用柑曼怡橙酒强化橙香与酒体。", "它延续龙舌兰、橙酒和青柠的经典结构，但口感更圆润。"),
    "grasshopper": ("20 世纪初", "青草蜢常被追溯到新奥尔良的图雅格餐厅酒吧，20 世纪初逐渐成形。", "绿色薄荷利口酒让它拥有鲜明外观，也让奶油型餐后酒多了轻快的一面。"),
    "hanky-panky": ("20 世纪初", "翻云覆雨由伦敦萨伏伊酒店的艾达·科尔曼创造，她是早期最具影响力的女性调酒师之一。", "菲奈布兰卡让金酒和甜味美思的组合带上尖锐草本感，名字来自客人品尝后的惊叹。"),
    ...
    "last-word": ("1910-1920 年代", "遗言源自底特律运动俱乐部，后来因 1950 年代酒谱留下记录。", "等量的金酒、绿查特酒、黑樱桃利口酒和青柠，让它在经典复兴中重新成名。"),
    ...
    "mary-pickford": ("1920 年代", "玛丽毕克馥诞生于古巴哈瓦那，以好莱坞默片明星玛丽·皮克福德命名。", "菠萝、石榴和黑樱桃风味让它带有热带与电影黄金时代的气息。"),
    ...
    "naked-and-famous": ("2011 年", "赤裸成名由华金·西莫创造，是遗言与纸飞机思路影响下的新派等量鸡尾酒。", "梅斯卡尔、黄查特酒、阿佩罗和青柠形成烟熏、草本、苦甜的清晰平衡。"),
    ...
    "planters-punch": ("19 世纪", "种植者宾治来自加勒比朗姆潘趣传统，常用押韵口诀记忆酸、甜、烈、弱的比例。", "它从殖民地种植园语境进入酒吧经典，后来出现许多地方版本。"),
    "porn-star-martini": ("2002 年", "艳星马天尼由伦敦调酒师道格拉斯·安克拉创造。", "百香果、香草伏特加和旁配香槟让它成为 21 世纪最流行的新派甜果型鸡尾酒之一。"),
    "porto-flip": ("19 世纪", "波特菲利普来自更古老的翻转类饮品传统，蛋黄与加强葡萄酒让口感厚实。", "它保留了餐后酒和旧式酒馆热饮传统的一部分影子。"),
    "ramos-fizz": ("1888 年", "拉莫斯菲士由新奥尔良调酒师亨利·拉莫斯创造。", "奶油、蛋白、柑橘和橙花水需要长时间摇和，使它成为调酒技法上的名作。"),
    "remember-the-maine": ("1930 年代", "铭记缅因号因查尔斯·贝克 1930 年代的旅行饮酒记录而知名。", "名字指向美西战争前的历史口号，配方则像曼哈顿加入樱桃与苦艾酒的变体。"),
    "russian-spring-punch": ("1980 年代", "俄罗斯之春宾治由伦敦调酒师迪克·布拉德塞尔创造。", "伏特加、柠檬、黑加仑和起泡酒让它在派对场景中轻盈又有层次。"),
    ...
    "sex-on-the-beach": ("1980 年代", "激情海岸兴起于 1980 年代美国度假酒吧与派对文化。", "伏特加、蜜桃利口酒和果汁带来直白甜美的热带风格。"),
    ...
    "ve-n-to": ("21 世纪", "威尼托来自意大利北部饮酒语境，名字直接指向威尼托地区。", "格拉帕、柠檬、蜂蜜和洋甘菊风味让它呈现温柔而明亮的地方感。"),
    "white-lady": ("1910-1920 年代", "白色佳人常与哈里·麦克艾尔洪和欧洲酒店酒吧传统联系在一起。", "金酒、橙酒与柠檬让它成为边车结构在金酒方向上的优雅版本。"),
    "missionarys-downfall": ("1930 年代", "传教士的堕落出自唐海滩客的提基酒吧体系，是朗姆、蜜桃、蜂蜜、薄荷和菠萝的热带组合。", "它不像许多烈性提基酒那样厚重，而是以碎冰和草本果香形成轻盈口感。"),
    ...
    "suffering-bastard": ("1940 年代", "痛苦混蛋诞生于开罗谢泼德酒店，常与调酒师乔·西亚洛姆在二战时期为士兵调制的故事相连。", "干邑、金酒、青柠和姜汁啤酒让它既有力量也足够清爽。"),
...
def translate_label(label):
    ...
    text = text.replace("柑曼怡橙酒橙酒", "柑曼怡橙酒")
