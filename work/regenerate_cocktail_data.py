...
ORIGINS = {
    ...
    "between-the-sheets": ("20 世纪上半叶", "被单之间常被认为出现在一战后到 1930 年代之间的欧洲酒店酒吧。", "它以侧车的酸酒骨架为基础，加入朗姆后更显热烈。"),
    ...
    "brandy-crusta": ("19 世纪中叶", "白兰地克拉斯塔诞生于新奥尔良，常与调酒师约瑟夫·桑蒂尼联系在一起。", "杯口糖边和长柠檬皮让它成为许多酸酒与侧车系作品的先声。"),
    ...
    "sidecar": ("一战前后", "侧车常被放在一战前后的巴黎或伦敦酒店酒吧背景中讨论。", "干邑、橙酒和柠檬形成的结构影响了许多后来的酸酒。"),
    ...
    "white-lady": ("1910-1920 年代", "白佳人常与哈里·麦克艾尔洪和欧洲酒店酒吧传统联系在一起。", "金酒、橙酒与柠檬让它成为侧车结构在金酒方向上的优雅版本。"),
